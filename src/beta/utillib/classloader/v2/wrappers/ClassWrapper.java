...
public class ClassWrapper {
    ...
    public IClassMethodCall getMethodByNameWPN(String name, String... parametertypes) {
    	return getMethodWPN(name, "void", parametertypes);
    }
    
    /**
     * Get Method By Name With Parameters Names (getMethodByNameWParametersNames)
     * @param name
    ...
    /**
     * Get Method By NameWith Parameters Classes (getMethodByNameWParametersClasses)
     * @param name
     * @param parametertypes
     * @return
     */
    ...
    public Object newInstanceEx() throws 
    ...
    public Object newInstanceEx(Object... args) throws
	    ClassNotFoundException, InstantiationException, IllegalAccessException,
	    IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
