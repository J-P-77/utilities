...
public class PluginManager {
	...
	public void loadDirectory(File directory) {
		if(directory == null) {
            ...
            _LOG_.printError(
                new RuntimeException("Variable[directory] - " + directory.getPath() + " Does Not Exists"));
...
/*} catch(IOException e) {*/
            ...
            if(!ClassUtil.implementsInterface(_PLUGIN_INTERFACE, clazz)) {
                ...
                if(isClassBlackListed(clazz.getName())) {
                    ...
                    try {
                        ...
                        PINFO._File = null;
                        PINFO._LibName = null;
                        PINFO._ClassLoader = ClassLoader.getSystemClassLoader();
	...
	public void unloadPlugin(IPluginInfo plugin) {
        final int INDEX = getPluginInfoIndex(plugin.getPluginName());
    ...
    private IPluginInfo getPluginInfoByIndex(int index, boolean checkin) {
        if(_PluginInfo.validIndex(index)) {
            if(checkin) {
...
//        }
    ...
    public static void main(String[] args) {
        final PluginManager P_MANAGER = new PluginManager(PluginManager.IPlugin.class, new DefaultDebugHandler("Plugin Manager", 5));

//        P_MANAGER.loadDirectory();
        P_MANAGER.loadLibrary("C:\\Documents and Settings\\Dalton Dell\\Desktop\\Java Tests\\BackupPlugins.jar");
//        P_MANAGER.loadLibrary("C:\\Documents and Settings\\Dalton Dell\\Desktop\\Java Tests\\BackupPlugins.zip");
    }*/
}
