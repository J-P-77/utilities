...
//    	}
    ...
    /**
     * 
     * @param  index (int) Index of Command
   ...
   /**
     * @param  name (String) Name of Command To Get
     * @param  matchcase (boolean) Match Case Sensitive
     * @return returns Commands
     */
    public Cmd findCommand(boolean matchcase, String name) {
        ...
        for(int X = 0; X < _Commands.length(); X++) {
            final String T_CMD = (matchcase ?
                _Commands.getAt(X).getName() : _Commands.getAt(X).getName().toLowerCase());
   ...
   /**
     * @param  name (String Array) Different Versions For Command Name To Find
   ...
   /**
     * @param  name (String Array) Command Name To Find
    ...
    public Cmd[] findCommands(boolean matchcase, String... names) {
        ...
        for(int X = 0; X < names.length; X++) {
            ...
            for(int Y = 0; Y < _Commands.length(); Y++) {
                final String T_CMD = (matchcase ?
                    _Commands.getAt(Y).getName() : _Commands.getAt(Y).getName().toLowerCase());
   ...
   /**
     * @param  name (String) Name of Command To Check If It Exists
     * @return returns true If Command Exists
     */
