...
public class FrmTextBox extends JFrame {
    ...
    public void removeFileMenu() {
        if(mnuFile != null) {
            if(mnuFileSave != null) {mnuFile.remove(mnuFileSave);}
            
            if(mnuFileOpen != null) {mnuFile.remove(mnuFileOpen);}
            
            if(mnuFileExit != null) {mnuFile.remove(mnuFileExit);}
            
            if(sep1 != null) {mnuFile.remove(sep1);}
