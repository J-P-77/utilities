...
//    public CacheManager() {}
    ...
    /**
     *
     * @param cachesize if cachesize is less then or equal to zero cache object will be destroyed
     * @param usetimecache
     * @param preserve
     */
    ...
    public Object addToCache(String key, Object obj) {
        if(isCacheAvailable()) {
            final int A_INDEX = (_UseTimeCache ?
                getAvailableCacheTime() : getAvailableCache());
