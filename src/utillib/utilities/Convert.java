...
public class Convert {
	...
	public static int convertStrToMillis_Beta(String value) {
        return strTo_Beta(value,
            new Pattern(1, "ms", "millis", "milli"),
            new Pattern(1000, "sec", "second"),
            new Pattern(1000 * 60, "min", "minute"),
            new Pattern(1000 * 60 * 60, "hr", "hour"));
    }

	public static int strToBytes_Beta(String value) {
        return strTo_Beta(value,
            new Pattern(1, "b", "byte"),
            new Pattern(1024, "kb", "kilobyte"),
            new Pattern(1024 * 1024, "mb", "megabyte"));
    }

	private static int strTo_Beta(String value, Pattern... pattern) {
        if(value == null || value.equals("") || value.startsWith("-")) {return -1;}
    ...
    private static class Pattern {
        ...
        public String getPattern(int index) {return _PATTERNS[index];}
        public int patternCount() {return _PATTERNS.length;}
    }
}
